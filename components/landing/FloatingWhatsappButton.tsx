...
type Props = { ariaLabel: string; whatsappLeadPrefix: string };

/** Botón fijo abajo a la derecha; visible al hacer scroll por la landing */
export function FloatingWhatsappButton({ ariaLabel, whatsappLeadPrefix }: Props) {
  return (
    <a
