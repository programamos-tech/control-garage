...
import { publicPath, serviceRouteKeys } from "@/lib/public-routes";
          ...
          <div className="mx-auto grid w-full max-w-7xl gap-10 md:grid-cols-2 lg:grid-cols-3 lg:gap-12">
            <div className="min-w-0 text-center md:text-left">
              ...
              <Link
                ...
                className="mt-3 inline-block text-sm font-semibold text-brand-gold-mid hover:text-brand-gold-light hover:underline"
              >
