...
/** Imágenes en `public/` — openers / motores (orden de presentación). */
const MOTOR_IMAGES = [
  "/motor11-1024x743.jpg",
  "/motor12-1024x743.jpg",
  "/moto13-1024x743.jpg",
  "/motor14-1024x737.jpg",
  "/motor15-1024x904.jpg",
  "/motor16-1024x992.jpg",
] as const;
...
export function MotorsCarousel({ dict }: Props) {
  ...
  const scrollByDir = (dir: -1 | 1) => {
    const el = scrollerRef.current;
    if (!el) return;
    const first = el.querySelector<HTMLElement>("[data-motor-slide]");
    const step = (first?.offsetWidth ?? 280) + 16;
